...
function Item({ name, desc, src, partner }) {
    return (
        <div className="flex flex-row items-center gap-5 p-3 font-content">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="text-sm leading-4 max-h-8 overflow-hidden opacity-70">{desc}</p>
                <div className="flex items-center gap-[1px]">
                    <span className="font-title text-[0.8rem] opacity-70">{partner}</span>
